...
class _LoginPageState extends State<LoginPage> {
        ...
        Padding(
          ...
          child: ConstrainedBox(
            ...
            child: RaisedButton(
              ...
              child: Text('Login',style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900, fontFamily: "Montserrat")),
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text("Or", style: TextStyle(color:Colors.black,fontSize: 16.0, fontFamily: "Montserrat"),),
                    ),
                    Container(
                      decoration: BoxDecoration(
                        gradient: new LinearGradient(
          ...
          children: <Widget>[
            ...
            GestureDetector(
              ...
              child: Text(
                ...
                style: TextStyle(fontWeight: FontWeight.w600, fontSize: 12, fontStyle: FontStyle.italic, color: Colors.blue),
              ),
            ),
          ],
      ),
  ...
  onClick(String email, String password) async{
    if(_key.currentState.validate()){
      ...
      OUser.User user = await loginWithUserNameAndPassword(email.trim(), password.trim());
  ...
  Future<OUser.User> loginWithUserNameAndPassword(String email, String password)async {
    try {
      UserCredential result = await FirebaseAuth.instance
          .signInWithEmailAndPassword(email: email, password: password);

      DocumentSnapshot documentSnapshot = await FireStoreUtils.firestore
          .collection(Constants.USERS).doc(result.user.uid).get();
      OUser.User user;
