...
class _signupPageState extends State<signup_page> {
  ...
  _onCameraClick() {
    final action = CupertinoActionSheet(
      message: Text("Add profile picture",style: TextStyle(fontSize: 15.0),
      ),
      actions: <Widget>[
                ...
                CircleAvatar(
                  ...
                  child: ClipOval(
                    child:SizedBox(
                      width: 170,
                      height: 170,
                      child: _image == null ? Image.asset('assets/placeholder.jpg', fit: BoxFit.cover,)
          ...
          Padding(
            ...
            child: ConstrainedBox(
              ...
              child: RaisedButton(
                ...
                child: Text('Sign Up', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900, fontFamily: "Montserrat"),
                ),
...
_sendToServer() async{
  if(_key.currentState.validate()){
    ...
    try {
      ...
      await FireStoreUtils.firestore.collection(Constants.USERS)
          .doc(result.user.uid)
          .set(user.toJson());
      hideProgress();
      ...
      (error as FirebaseException).code != 'ERROR_EMAIL_ALREADY_IN_USE' ?
        ...
        showAlertDialog(context, 'Failed','Email already in use. Please pick another email address');
