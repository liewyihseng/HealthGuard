...
class _PostTitleAndSummary extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    ...
    final String title = demoval.postTitle;
    final String summary = demoval.postDesc;
...
class _PostImage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Expanded(flex: 2, child: Image.asset(demoval.postImage));
  }
}
    ...
    return Expanded(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            Text(demoval.userName, style: nameTheme),
            SizedBox(height: 2.0),
            Text(demoval.userEmail, style: emailTheme),
          ],
        ),
      ),
    );
...
class _UserImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      flex: 1,
      child: CircleAvatar(
        backgroundImage: AssetImage(demoval.userImage),
      ),
    );
  }
}
